...
## results across all peers (multiplayer sync). Set before _ready().
...
## last frame. Used for Fall (ragdoll) — plays once at 2x speed, holds
## last frame. Minimal blend for snappy start.
